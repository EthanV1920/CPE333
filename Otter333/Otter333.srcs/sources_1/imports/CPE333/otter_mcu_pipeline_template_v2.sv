...
module otter_mcu_pipeline_template_v2 (
    input CLK,
    input INTR,
    input RESET,
    input [31:0] IOBUS_IN,
  ...
  RegFile otter_reg_file (
      .en(cu_rf_we),
      .adr1(if_de_reg[19:15]),
      .adr2(if_de_reg[24:20]),
      .w_adr(),  // add from write back
      .w_data(RF_MUX_out),
      .CLK(CLK),
      .rs1(sreg1),
      .rs2(sreg2)
  ...
  ALU_MUX_A otter_alu_muxA (
      ...
      .ALUmuxA1(U_imm),
      .ALUmuxA2(~sreg1),
      .ALUmuxA_SEL(mux_a_sel),
      .ALUmuxA_out(mux_a_out)
  );
  ...
  ALU_MUX_B otter_alu_muxB (
      ...
      .ALUmuxB3(pc_out),
      .ALUmuxB4(csr_rd),
      .ALUmuxB_SEL(mux_b_sel),
      .ALUmuxB_out(mux_b_out)
  );


  instr_t id_ex_struct;
  ...
  always_ff @(posedge CLK) begin
    ...
    // TODO: figure out what inputs this should be
  ...
  ALU otter_ALU (
      .srcA(id_ex_struct.mux_A_out),
      .srcB(id_ex_struct.mux_B_out),
      .alu_fun(id_ex_struct.alu_fun),
      .alu_result(id_ex_struct.regWrite)
  );
  ...
  Memory otter_memory (
      ...
      .MEM_RDEN2(cu_memRDEN2),
      .MEM_WE2(cu_memWE2),
      .MEM_SIZE(if_de_reg[13:12]),
      .MEM_SIGN(if_de_reg[14]),
      .MEM_DOUT2(out_data2),
      .MEM_DOUT1(if_de_reg),
      .IO_IN(IOBUS_IN),
      .IO_WR(IOBUS_WR),

...
module ALU(
    ...
    always_comb begin
        case(alu_fun)
            ...
            4'b0101: alu_result = (srcA >> srcB[4:0]); //logical shift right (srl)
            4'b0001: alu_result = (srcA << srcB[4:0]); //logical shift left (sll)
            4'b1101: alu_result = ($signed(srcA) >>> srcB[4:0]); //arithmetic shift right (sra)

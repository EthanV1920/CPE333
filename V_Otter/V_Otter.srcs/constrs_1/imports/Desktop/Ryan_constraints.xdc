...
### Supply voltages - needed when using clock
...
#set_property PACKAGE_PIN T18 [get_ports {Prch}]						
#	set_property IOSTANDARD LVCMOS33 [get_ports {Prch}]
#set_property PACKAGE_PIN W19 [get_ports {Nkl}]						
#	set_property IOSTANDARD LVCMOS33 [get_ports {Nkl}]
#set_property PACKAGE_PIN T17 [get_ports {Qtr}]						
#	set_property IOSTANDARD LVCMOS33 [get_ports {Qtr}]
#set_property PACKAGE_PIN U17 [get_ports {Rfnd}]						
#	set_property IOSTANDARD LVCMOS33 [get_ports {Rfnd}]
